...
function guardaryeditar(e){
     ...
     $.ajax({
     	url: "../ajax/poliza.php?op=guardaryeditar",
     	type: "POST",
     	data: formData,
     	contentType: false,
     	processData: false,
...
function mostrar(id){
	$.post("../ajax/poliza.php?op=mostrar",{id : id},
...
function eliminar(id){
	Swal.fire({
		...
		if (result.isConfirmed) {
			$.post("../ajax/poliza.php?op=eliminar", {id : id }, function(e){
		  Swal.fire(
			  e,
			  'Eliminado!',
			  'success');
